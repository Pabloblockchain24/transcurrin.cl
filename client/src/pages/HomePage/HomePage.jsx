...
function HomePage() {
  ...
  return (
    ...
    <div className='customBanner'>
      <div className='aux'>
        <h1 className='customTitleBanner' >SOLUCIONES LOGISTICAS A TU MEDIDA</h1>
        <h2 className='customTitleBanner2'> Nos adaptamos a tus necesidades </h2>
        <button className='buttonBanner'> CONTACTANOS AQUI</button> 
      </div>
    </div>


    <div className='customBanner2'>
      <div className='aux'>
        <h1 className='customTitleBanner' >EXPERIENCIA A TU SERVICIO</h1>
        <h2 className='customTitleBanner2'> 35 años de operación nos respaldan </h2>
        <button className='buttonBanner'> CONTACTANOS AQUI</button> 
      </div>
    </div>

    <div className='customBanner3'>
      <div className='aux'>
        <h1 className='customTitleBanner' >CENTRATE EN TU NEGOCIO PRINCIPAL</h1>
        <h2 className='customTitleBanner2'> Despreocupate de la logistica de tu carga</h2>
        <button className='buttonBanner'> CONTACTANOS AQUI</button> 
      </div>
    </div>
